...
export const roleAreas: RoleArea[] = [
  ...
  },
  {
    ...
    home: "/trainer",
    items: [
      { label: "Dashboard", to: "/trainer", icon: LayoutDashboard, group: "Overview" },
      { label: "Notifications", to: "/trainer/notifications", icon: Bell, group: "Overview" },
      { label: "Chat", to: "/trainer/chat", icon: MessageSquare, group: "Overview" },
      { label: "Booking calendar", to: "/trainer/schedule", icon: CalendarDays, group: "Schedule" },
      { label: "Days off", to: "/trainer/days-off", icon: Clock, group: "Schedule" },
      { label: "Reschedules", to: "/trainer/reschedule", icon: CalendarClock, group: "Schedule" },
      { label: "Verify sessions", to: "/trainer/verify", icon: ClipboardCheck, group: "Schedule" },
      { label: "My customers", to: "/trainer/customers", icon: Users, group: "Coaching" },
      { label: "Live session", to: "/trainer/live", icon: PlayCircle, group: "Coaching" },
      { label: "Session feedback", to: "/trainer/feedback", icon: MessageSquare, group: "Coaching" },
      { label: "Progress & metrics", to: "/trainer/progress", icon: TrendingUp, group: "Coaching" },
      { label: "Workout plans", to: "/trainer/plans", icon: Route, group: "Plans" },
      { label: "AI plan suggestion", to: "/trainer/plans/ai", icon: Sparkles, group: "Plans" },
      { label: "Nutrition plans", to: "/trainer/nutrition", icon: ClipboardList, group: "Plans" },
      { label: "Lesson plans", to: "/trainer/lessons", icon: CalendarDays, group: "Plans" },
      { label: "Exercises", to: "/trainer/exercises", icon: Dumbbell, group: "Plans" },
      { label: "Profile", to: "/trainer/profile", icon: User, group: "Account" },
      { label: "Certificates", to: "/trainer/certificates", icon: Shield, group: "Account" },
      { label: "My reviews", to: "/trainer/reviews", icon: Star, group: "Account" },
    ],
  },
  {
    key: "staff",
